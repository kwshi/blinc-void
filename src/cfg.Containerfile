...
RUN ["ln", "-sfT", "/usr/share/blinc/dotfiles/misc/mimeapps", "mimeapps.list"]
...
RUN ["ln", "-sT", "/data/gnupg", ".gnupg"]
RUN ["ln", "-sT", "/data/pass", ".password-store"]
...
RUN ["ln", "-sT", "/data/containers/kshi", ".local/share/containers"]
